...
class FieldCanvas(QtWidgets.QWidget):
    ...
    drawing_finished: Callable[[], None]  # Called when mouse release ends a drawing
    ...
    def mouseReleaseEvent(self, event: QtGui.QMouseEvent) -> None:
        if event.button() == QtCore.Qt.MouseButton.LeftButton:
            self._recording = False
            # Notify that drawing has finished
            if hasattr(self, "drawing_finished") and self.drawing_finished:
